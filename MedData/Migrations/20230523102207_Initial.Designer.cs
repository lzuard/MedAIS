...
namespace MedData.Migrations
{
    ...
    [Migration("20230523102207_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedData.Entities.Allergen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MedData.Entities.Diagnoses", b =>
                {
                    b.Property<int>("HospitalizationId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MedData.Entities.Checkups", b =>
                {
                    ...
                    b.HasOne("MedData.Entities.Сheckup", null)
                        .WithMany("Checkups")
                        .HasForeignKey("СheckupId");

                    b.HasOne("MedData.Entities.Checkups", "Checkup_s")
                        .WithMany()
            ...
            modelBuilder.Entity("MedData.Entities.Diagnoses", b =>
                {
                    b.HasOne("MedData.Entities.Diagnosis", "Diagnosis")
                        .WithMany("Diagnoses")
